...
public enum GoogleDocsExceptionStatus implements BaseExceptionStatus {
	...
	GOOGLE_DOCS_NOT_ACCESS("구글 독스에 접근 권한이 없습니다. 문서의 접근 권한을 변경해주세요.", 400, "74001"),
	GOOGLE_DOCS_NOT_EXIST("없는 구글 독스입니다.", 400, "74002"),
	DOCS_FORBIDDEN("권한이 없는 접근입니다.", 403, "74030"),
	DOCS_NOT_FOUND("존재하지 않는 데이터입니다.", 404, "74040"),
